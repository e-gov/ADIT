...
public class AccessRestriction implements java.io.Serializable {
    ...
    public AccessRestriction(long id, AditUser aditUser, RemoteApplication remoteApplication) {
        this.id = id;
        this.aditUser = aditUser;
        this.remoteApplication = remoteApplication;
    }

    public AccessRestriction(long id, AditUser aditUser, RemoteApplication remoteApplication, String restriction) {
        this.id = id;
        this.aditUser = aditUser;
        this.remoteApplication = remoteApplication;
