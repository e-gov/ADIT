...
GRANT select, insert, update, delete ON &&ADIT_SCHEMA..NOTIFICATION TO &&ADIT_APP.;
...
GRANT select, insert, update, delete ON &&ADIT_SCHEMA..USER_NOTIFICATION TO &&ADIT_APP.;
...
-- Sequences
GRANT select ON &&ADIT_SCHEMA..ADIT_LOG_ID_SEQ TO &&ADIT_APP.;
GRANT select ON &&ADIT_SCHEMA..DOCUMENT_FILE_ID_SEQ TO &&ADIT_APP.;
GRANT select ON &&ADIT_SCHEMA..DOCUMENT_HISTORY_ID_SEQ TO &&ADIT_APP.;
GRANT select ON &&ADIT_SCHEMA..DOCUMENT_ID_SEQ TO &&ADIT_APP.;
GRANT select ON &&ADIT_SCHEMA..DOCUMENT_SHARING_ID_SEQ TO &&ADIT_APP.;
GRANT select ON &&ADIT_SCHEMA..DOWNLOAD_REQUEST_LOG_ID_SEQ TO &&ADIT_APP.;
GRANT select ON &&ADIT_SCHEMA..ERROR_LOG_ID_SEQ TO &&ADIT_APP.;
GRANT select ON &&ADIT_SCHEMA..METADATA_REQUEST_LOG_ID_SEQ TO &&ADIT_APP.;
GRANT select ON &&ADIT_SCHEMA..NOTIFICATION_ID_SEQ TO &&ADIT_APP.;
GRANT select ON &&ADIT_SCHEMA..REQUEST_LOG_ID_SEQ TO &&ADIT_APP.;
GRANT select ON &&ADIT_SCHEMA..SIGNATURE_ID_SEQ TO &&ADIT_APP.;