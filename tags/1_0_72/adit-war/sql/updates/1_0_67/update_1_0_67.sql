...
update &&ADIT_SCHEMA..document_sharing docsh set docsh.dvk_id=
  (
    select mr.dhl_id from &&ADIT_DVK_SCHEMA..DHL_MESSAGE_RECIPIENT mr join &&ADIT_DVK_SCHEMA..dhl_message dm on dm.dhl_message_id=mr.dhl_message_id where mr.dhl_message_id=
