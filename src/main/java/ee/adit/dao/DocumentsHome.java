...
public class DocumentsHome {
	...
	public Documents merge(Documents detachedInstance) {
		...
		try {
			Documents result = (Documents) sessionFactory.getCurrentSession()
	...
	public Documents findById(long id) {
		...
		try {
			Documents instance = (Documents) sessionFactory.getCurrentSession()
					.get("ee.adit.dao.Documents", id);
			if (instance == null) {
	...
	public List findByExample(Documents instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria(
					"ee.adit.dao.Documents").add(Example.create(instance))
					.list();
