...
public class DeleteDocumentFileEndpoint extends AbstractAditBaseEndpoint {
	...
	protected Object invokeInternal(Object requestObject, int version) throws Exception {
		LOG.debug("deleteDocumentFile invoked. Version: " + version);
	...
	protected Object v1(Object requestObject) {
		...
		try {
			...
			DocumentHistory historyEvent = new DocumentHistory(
				...
				xroadRequestUser,
				header);
			historyEvent.setDescription(DocumentService.DocumentHistoryDescription_DeleteFile + request.getFileId());
			...
			String additionalMessage = this.getMessageService().getMessage("request.deleteDocumentFile.success", new Object[] {}, Locale.ENGLISH);
	 ...
	 * 
	 * @param request				Request body as {@link DeleteDocumentFileRequest} object.
