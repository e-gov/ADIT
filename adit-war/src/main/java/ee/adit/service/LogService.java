...
public class LogService {
     ...
     */
    public Long addRequestLogEntry(String requestName, Long documentId, Date requestDate,
            String remoteApplicationShortName, String userCode, String organizationCode, String additionalInformation) {
     ...
     * @return log entry ID
     */
    public Long addErrorLogEntry(String actionName, Long documentId, Date errorDate, String remoteApplicationShortName,
            String userCode, String errorLevel, String errorMessage) {
     ...
     * @return log entry ID
     */
    public Long addDownloadRequestLogEntry(Long documentId, Long documentFileId, Date requestDate, String appName,
     ...
     * @return log entry ID
     */
    public Long addMetadataRequestLogEntry(Long documentId, Date requestDate, String appName, String userCode,
            String orgCode) {
