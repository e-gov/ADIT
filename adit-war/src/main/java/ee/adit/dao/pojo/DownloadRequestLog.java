...
public class DownloadRequestLog implements java.io.Serializable {
    ...
    public DownloadRequestLog(long id, Long documentId, Long documentFileId, Date requestDate,
            String remoteApplicationShortName, String userCode, String organizationCode) {
        this.id = id;
